"""
Revolut X Multi-Asset Auto-Trader (Ed)
=======================================
...
Usage:
  python crypto_revolut_ed.py                  # Interactive
  python crypto_revolut_ed.py --loop           # Auto-loop all assets
  python crypto_revolut_ed.py --dry-run --loop # Signals only
  python crypto_revolut_ed.py --status         # All positions
  python crypto_revolut_ed.py --balance        # Revolut X balance
  python crypto_revolut_ed.py --setup-telegram
  python crypto_revolut_ed.py --reset          # Reset all positions
"""
...
def run_loop(trading_cfg, dry_run=False):
    ...
    print(f"\n{'='*60}")
    print(f"  REVOLUT X MULTI-ASSET TRADER [ED {mode}]")
...
def main():
    print("=" * 60)
    print("  REVOLUT X MULTI-ASSET TRADER [ED]")
