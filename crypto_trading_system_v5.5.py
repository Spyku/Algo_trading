"""
Crypto Hourly Trading System — V5.5 (Strategy Optimizer)
============================================================
Based on V5.4 production. Adds enhanced Mode F with 2-phase
confidence optimization across all 4 strategies.

V5.5 changes:
  - Mode F: tests all 4 strategies (4h_only, 8h_only, both_agree, either_agree)
    at every coarse confidence level (55-85% in 5% steps)
  - Phase 2: fine-tunes best confidence +/-3% in 1% steps
  - Writes optimal strategy + confidence to trading_config.json
