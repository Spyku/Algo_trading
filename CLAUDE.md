...
**Verdict (2026-06-26 4h/4h week):** ruled out bad signals (snapshot replay 100%, closes good), bad execution (clean maker fills), data corruption (a tz artifact). **Cause = the backtest's zero-lag decision-bar-close fill assumption**: the +2.40% edge collapses to ~−2.9% with a single bar of execution lag, ≈ the live −3.78%. Frequent 4h trading + a volatile week maximized the exposure. **The live realized PnL is the honest number; the backtest overstates.**
