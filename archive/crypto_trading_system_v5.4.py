"""
Crypto Hourly Trading System — V5.4
============================================================
...
CLI Usage (skip all menus):
  python crypto_trading_system_v5.4.py B BTC 4,8h
  python crypto_trading_system_v5.4.py D ETH 8h 1y
  python crypto_trading_system_v5.4.py D BTC,ETH 4,8h 2y
