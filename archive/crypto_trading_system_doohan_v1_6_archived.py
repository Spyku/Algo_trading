"""
Doohan — Discrete Optuna search + LGBM-required combos
============================================================
...
Outputs:
  ...
  models/crypto_doohan_best_models.csv
...
def _get_models_csv_path():
    ...
    if OPTUNA_METRIC != 'apf':
        return f'{MODELS_DIR}/crypto_doohan_best_models_{OPTUNA_METRIC}.csv'
    return f'{MODELS_DIR}/crypto_doohan_best_models.csv'


def _backup_models_csv():
    """Create a timestamped backup of production CSV before writing (failsafe against contamination)."""
    src = f'{MODELS_DIR}/crypto_doohan_best_models.csv'
    if os.path.exists(src) and not MODELS_CSV_OVERRIDE:
        import shutil
        bak = f'{MODELS_DIR}/crypto_doohan_best_models_backup.csv'
