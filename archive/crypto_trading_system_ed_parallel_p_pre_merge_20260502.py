...
# Engine + V/S/T parallel wrapper were merged into a single
# `crypto_trading_system_ed` module on 2026-05-02. The Mode P patches below
# operate on engine internals (PySR discovery code path).
